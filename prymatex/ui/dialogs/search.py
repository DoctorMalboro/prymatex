...
class Ui_SearchDialog(object):
    def setupUi(self, SearchDialog):
        ...
        self.radioButtonProject = QtGui.QRadioButton(self.groupBox_2)
        self.radioButtonProject.setChecked(True)
        self.radioButtonProject.setObjectName(_fromUtf8("radioButtonProject"))
        self.verticalLayout_2.addWidget(self.radioButtonProject)
    ...
    def retranslateUi(self, SearchDialog):
        ...
        self.radioButtonProject.setText(_('Project'))
